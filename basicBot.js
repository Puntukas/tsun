...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("http://tsunbot.webatu.com/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "TsunBot",
        loggedInID: null,
        scriptLink: "http://tsunbot.webatu.com/basicBot.js",
        cmdLink: "http://tsunbot.webatu.com/commands.md",
        chatLink: "http://tsunbot.webatu.com/lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "http://tsunbot.webatu.com/blacklists/NSFW.json",
                OP: "http://tsunbot.webatu.com/blacklists/OP.json"
            }
        },
        room: {
            users: [],
